About strsimpy-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/strsimpy-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/strsimpy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/strsimpy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `strsimpy` available on your platform:
...
```
mamba search strsimpy --channel conda-forge
```
...
```
pixi search strsimpy --channel conda-forge
```
...
mamba repoquery search strsimpy --channel conda-forge

# List packages depending on `strsimpy`:
mamba repoquery whoneeds strsimpy --channel conda-forge

# List dependencies of `strsimpy`:
mamba repoquery depends strsimpy --channel conda-forge
```
